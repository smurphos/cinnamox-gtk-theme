...
if expr "$GTK2_GRAD_1" : '-\?[0-9]\+$' >/dev/null; then
  ...
  GTK2_SP_LARGE=0
  GTK2_SP_XLARGE=1
  GTK2HIDPI_SP_SMALL=0
  GTK2HIDPI_SP_MEDIUM=1
  GTK2HIDPI_SP_LARGE=1
  GTK2HIDPI_SP_XLARGE=2
  
if (( SPACING > 2 )); then
  GTK2_SP_SMALL=$(( SPACING - 3 ))
  GTK2_SP_MEDIUM=$(( SPACING - 2 ))
  GTK2_SP_LARGE=$(( SPACING - 1 ))
  GTK2_SP_XLARGE=$(( SPACING + 1 ))
  GTK2HIDPI_SP_SMALL=$(( (( SPACING * 2 )) - 6 ))
  GTK2HIDPI_SP_MEDIUM=$(( (( SPACING * 2 )) - 4 ))
  GTK2HIDPI_SP_LARGE=$(( (( SPACING * 2 )) - 2 ))
  GTK2HIDPI_SP_XLARGE=$(( ((SPACING * 2 )) + 2 ))
elif (( SPACING > 1 )); then
  GTK2_SP_LARGE=1
  GTK2_SP_XLARGE=2
  GTK2HIDPI_SP_LARGE=2
  GTK2HIDPI_SP_XLARGE=4
fi
  GTK2_SP_IND=9
  GTK2_SP_SLIDERW=6
  GTK2_SP_SLIDERL=60
  GTK2HIDPI_SP_IND=15
  GTK2HIDPI_SP_SLIDERW=10
